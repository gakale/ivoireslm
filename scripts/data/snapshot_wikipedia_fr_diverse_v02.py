...
DEFAULT_OUTPUT = STORAGE_ROOT / "snapshots/wikipedia_fr_diverse_v0.2"
PREVIOUS_SNAPSHOT = STORAGE_ROOT / "snapshots/wikipedia_fr_diverse_v0.1/pages.jsonl"
API_URL = "https://fr.wikipedia.org/w/api.php"
USER_AGENT = "IvoireSLM/0.4 (research corpus; https://github.com/gakale/ivoireslm)"
MAX_WORKERS = 8

CATEGORY_PLAN = (
    ("Catégorie:Côte d'Ivoire", 4, 6_000, 800, "cote_ivoire"),
    ("Catégorie:Afrique de l'Ouest", 3, 4_000, 500, "afrique_ouest"),
    ("Catégorie:Mathématiques", 3, 5_000, 700, "mathematiques"),
    ("Catégorie:Science", 2, 4_000, 500, "sciences"),
    ("Catégorie:Histoire", 2, 3_500, 450, "histoire"),
    ("Catégorie:Géographie", 2, 3_500, 450, "geographie"),
    ("Catégorie:Culture", 2, 3_500, 450, "culture"),
    ("Catégorie:Société", 2, 3_500, 450, "societe"),
    ("Catégorie:Éducation", 3, 3_000, 450, "education"),
    ("Catégorie:Santé", 2, 3_000, 400, "sante"),
    ("Catégorie:Informatique", 2, 3_000, 400, "informatique"),
    ("Catégorie:Économie", 2, 3_000, 400, "economie"),
    ("Catégorie:Littérature", 2, 3_000, 400, "litterature"),
    ("Catégorie:Art", 2, 2_500, 350, "arts"),
    ("Catégorie:Droit", 2, 2_500, 350, "droit"),
    ("Catégorie:Environnement", 2, 2_500, 350, "environnement"),
    ("Catégorie:Technologie", 2, 2_500, 350, "technologie"),
)
...
def stable_score(page: dict) -> bytes:
    value = f"frwiki-diverse-v0.2:{page['pageid']}:{page['title']}"
...
def write_snapshot(
    ...
    report = {
        "snapshot_id": "wikipedia_fr_diverse_v0.2",
        "source": API_URL,
        "category_plan": [
            {
                "root": root,
